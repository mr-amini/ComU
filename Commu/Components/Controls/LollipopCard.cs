...
public class LollipopCard : Control
{
    ...
    Color TColor = Color.MediumSeaGreen;
    Color CColor = Color.Gray;
    Color BColor = Color.MediumSeaGreen ;

    Cursor okcursor = Cursor.Current;
    ...
    [Category("Appearance")]
    public Cursor OKButtonCursor
    {
        get { return okcursor; }
        set
        {
            okcursor = value;
            OKButton.Cursor = okcursor;
            Invalidate();
        }
    }
    ...
    {
        OKButton.FontColor = BColor;
        OKButton.FadeMotionColor = Color.FromArgb(30, BColor);
    ...
    private class MultilineStringEditor
    {
    }
}
